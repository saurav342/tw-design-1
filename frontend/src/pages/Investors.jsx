...
const Investors = () => (
  <div className="mx-auto flex max-w-7xl flex-col gap-16 px-4 py-12 lg:px-8">
    <section className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap gap-4">
          <Link to="/signup/investor" className="rounded-full bg-blossom px-6 py-3 text-sm font-semibold uppercase tracking-wide text-white shadow-lg shadow-[0_28px_75px_rgba(255,79,154,0.35)] hover:bg-royal">
            Request access
          </Link>
      ...
      <div className="rounded-3xl bg-night-soft p-8">
        ...
        <ul className="mt-6 space-y-4 text-sm text-slate-600">
          <li className="flex items-start gap-3">
            <span className="mt-1 h-2.5 w-2.5 rounded-full bg-sunbeam" />
          ...
          <li className="flex items-start gap-3">
            <span className="mt-1 h-2.5 w-2.5 rounded-full bg-sprout" />
    ...
    <section className="rounded-3xl bg-gradient-to-r from-sprout via-mint to-blossom px-6 py-12 text-night shadow-lg shadow-[0_28px_75px_rgba(46,220,146,0.25)]">
      <div className="flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between">
        <div className="space-y-3">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-night/60">
            Ready to co-invest?
          </p>
        ...
        <Link to="/login" className="rounded-full bg-night px-6 py-3 text-sm font-semibold uppercase tracking-wide text-white hover:bg-sunbeam">
          Schedule session
        </Link>
      </div>
    </section>
