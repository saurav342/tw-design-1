    ...
    <div className="grid gap-6 md:grid-cols-2">
      {resources.map((resource) => (
        <div key={resource.title} className="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm shadow-slate-200">
          <div className="inline-flex rounded-full bg-brand-muted px-3 py-1 text-xs font-semibold uppercase tracking-wide text-burnt">
            {resource.type}
          </div>
          <h3 className="mt-4 text-xl font-semibold text-brand-dark">{resource.title}</h3>
